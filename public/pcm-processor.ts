// components/AudioManager/PCMProcessor.ts
export class PCMProcessor {
  // The actual implementation is in public/pcm-processor.js
  // This class is just a placeholder for documentation purposes
  
  static getProcessorSource(): string {
    return `
